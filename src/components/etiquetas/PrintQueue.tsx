 ...
 *
 * Ao clicar em imprimir, TODOS os volumes da NF são enviados em sequência,
 * sem confirmação intermediária. A enumeração (1/N, 2/N, ...) é aplicada
 * automaticamente a cada etiqueta e cada volume é registrado no histórico.
 */
