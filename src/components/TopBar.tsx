...
export default function TopBar() {
  ...
  return (
    <motion.header
      ...
      className="topbar-bg text-primary-foreground flex items-center gap-4 px-6 h-14 sticky top-0 z-50"
    ...
    >
      ...
      <div className="flex items-center gap-2.5 flex-shrink-0">
        ...
        <div>
          <div className="font-semibold text-sm">Conferência de Tecidos</div>
          <div className="text-[11px] opacity-40 font-mono mt-px">SAP B1 · Multi-IA</div>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2">
        <span className="text-[11px] font-mono text-white/40 uppercase tracking-wider whitespace-nowrap">NFe</span>
        <input
          className="glass-input font-mono font-medium w-[150px]"
          value={nfe}
      ...
      <div className="flex gap-1 ml-auto">
        <div className="stat-pill">
          <span className="font-semibold font-mono text-white">{registros.length}</span>
          <span className="text-white/35 text-[10px] uppercase tracking-wider">Rolos</span>
        </div>
        <div className="stat-pill">
      ...
      <div className="flex gap-1.5">
        <button className="glass-btn-accent glass-btn" onClick={exportExcel}>↓ Excel</button>
      </div>
    </motion.header>
  );
}
