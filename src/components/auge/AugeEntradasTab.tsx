...
import { Search, RefreshCw, Loader2, FileText, Clock, User, Archive, DollarSign, AlertTriangle, PackagePlus } from '@/components/icons';
    ...
    <div className="space-y-4">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 gap-3">
          {visible.map(r => (
            <div key={r.id} className="bg-card/60 border border-border/40 rounded-md p-4 hover:border-emerald-500/30 transition-colors">
