...
import { Home, ScanLine, TreePine, Zap, Table, FolderOpen, Package, ArrowUpRight, Settings, LogOut, ClipboardCheck, MapPin, AlertCircle, LayoutDashboard, ShieldAlert } from 'lucide-react';
