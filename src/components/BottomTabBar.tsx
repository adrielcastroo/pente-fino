...
export default function BottomTabBar() {
  ...
  return (
    <nav
      className="flex min-[1366px]:hidden tablet-landscape:hidden fixed bottom-0 left-0 right-0 z-50 h-16 border-t border-border/40 bg-background/95 backdrop-blur shadow-2xl"
